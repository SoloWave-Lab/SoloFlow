...
export interface ScrubberState extends MediaBinItem {
  ...
  // Effects (optional - loaded from database)
  visualEffects?: import("./advanced-types").VisualEffect[];
  colorCorrection?: import("./advanced-types").ColorCorrection;
  audioEffects?: import("./advanced-types").AudioEffect[];
  blendMode?: string;
  opacity?: number;
}

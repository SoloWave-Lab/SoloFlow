    ...
    <footer className="w-full border-t border-border/30 bg-background/70 backdrop-blur supports-[backdrop-filter]:bg-background/50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
        <div className="inline-flex items-center gap-2">
          ...
          <span>© {new Date().getFullYear()} Kylo Studio</span>
        </div>
        <nav className="flex flex-wrap items-center gap-4">
          <a href="https://doc.kylo.flyingdarkdev.in" className="hover:text-foreground" target="_blank" rel="noopener noreferrer">Docs</a>
          ...
          <a href="https://github.com/SoloWave-Lab/Kylo" target="_blank" rel="noreferrer" className="hover:text-foreground">GitHub</a>
          <a href="https://discord.gg/" target="_blank" rel="noreferrer" className="hover:text-foreground">Discord</a>
          <a href="https://twitter.com/Kylo" target="_blank" rel="noreferrer" className="hover:text-foreground">Twitter</a>
        </nav>
      </div>
    </footer>
  );

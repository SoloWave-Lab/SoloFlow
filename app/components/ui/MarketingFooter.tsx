        ...
        <footer className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-20 sm:pt-24 pb-[40vw] sm:pb-[32vw] md:pb-[22vw] grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-y-12 gap-x-12 md:gap-x-16 font-mono">
          ...
          <div className="md:col-start-7 md:col-span-2">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="https://doc.kylo.flyingdarkdev.in" className="hover:underline" target="_blank" rel="noopener noreferrer">Docs</a></li>
              <li>
          ...
          <div className="md:col-start-11 md:col-span-2">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="https://twitter.com/Kylo" target="_blank" rel="noreferrer" className="hover:underline">X</a></li>
              <li><a href="https://github.com/SoloWave-Lab/Kylo" target="_blank" rel="noreferrer" className="hover:underline">GitHub</a></li>
              <li><a href="https://discord.gg/" target="_blank" rel="noreferrer" className="hover:underline">Discord</a></li>
            </ul>
          </div>
        </footer>

        {/* Big Kylo wordmark pinned to the very bottom */}
        <div className="absolute bottom-0 left-0 right-0 flex justify-center pointer-events-none z-0">
          <h1 className="text-[16vw] md:text-[18vw] font-extrabold leading-none text-black/10 select-none tracking-tight">TRYKYLO</h1>
        </div>
      </div>
    </div>
  );

...
import { useNavigate, type LoaderFunctionArgs } from '~/lib/router-utils';
    ...
    <div className="min-h-screen w-full bg-background relative overflow-hidden">
      ...
      <header className="h-10 sm:h-12 border-b border-border/50 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 flex items-center justify-between px-3 sm:px-6">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-sm font-medium truncate">Kylo Studio</span>
        </div>
      ...
      {/* Playful Kylo mascot: gentle float in the corner; spin with chime on click */}
      ...
      <div
        ...
        onClick={() => {
          ...
          try {
            ...
            console.error("Kylo mascot chime failed");
          }
        }}>
        <KimuLogo
          id="kimu-mascot"

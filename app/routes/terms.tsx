...
export default function Terms() {
  const lastUpdated = `8th October 2025`
        ...
        <div className="relative rounded-2xl border border-border/30 bg-background/80 shadow-2xl p-6 md:p-10">
          ...
          <div className="text-left mb-8 pb-6 border-b border-border/20">
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <span className="text-sm font-semibold tracking-tight">Kylo</span>
            </div>
            <div className="mx-auto max-w-3xl rounded-lg border border-border/30 bg-muted/5 px-4 py-3 text-xs font-mono text-muted-foreground">
              ...
              Kylo — a web‑based video editor with AI features and optional
              cloud storage and collaboration. By creating an account or using
              Kylo, you agree to these Terms.
            </div>
          </div>
            ...
            <div className="space-y-8 text-foreground leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    By accessing or using Kylo, you accept these Terms and our
                    Privacy Policy. If you don’t agree, do not use Kylo.
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    Kylo provides a browser‑based non‑linear video editor,
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    ...
                    other content you upload or create in Kylo ("User Content").
                  </p>
                  <p>
                    To operate Kylo, you grant us a limited, worldwide,
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    ...
                    provide suggestions or feedback, you grant Kylo a perpetual,
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    Kylo, including its UI, code, and design elements, is owned
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    Kylo may integrate or link to third‑party services (e.g.,
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    Kylo is provided on an “as is” and “as available” basis
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    To the maximum extent permitted by law, Kylo and its
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    You agree to indemnify and hold Kylo harmless from any
                    claims, damages, liabilities, and expenses (including
                    reasonable attorney fees) arising from your use of Kylo,
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    ...
                    where Kylo is organized and operates, without regard to
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    ...
                    continued use of Kylo after changes become effective
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    ...
                    <a href="mailto:yaouhaveme064@gmail.com" className="underline">
                      yaouhaveme064@gmail.com
                    </a>{" "}
                    or via <a href="https://discord.com/" target="_blank" rel="noreferrer" className="underline">Discord</a>.
                  </p>
                </div>
              </section>
            </div>
          ...
          <div className="mt-16 pt-6 border-t border-border/20 flex items-center justify-between text-xs md:text-sm">
            ...
            <a
              ...
              title="Back to Kylo"
            >
              <KimuLogo className="w-4 h-4" /> Return to Kylo
            </a>
          </div>
        </div>
      </div>
